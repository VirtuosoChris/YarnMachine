...
void Node::set_sourcetextstringid(ArgT0&& arg0, ArgT... args) {
 ...
 sourcetextstringid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Node::set_allocated_sourcetextstringid(std::string* sourcetextstringid) {
  ...
  sourcetextstringid_.SetAllocated(sourcetextstringid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (sourcetextstringid_.IsDefault()) {
